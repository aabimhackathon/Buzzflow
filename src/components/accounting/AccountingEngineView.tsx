...
import { AccountingEngineSkeleton } from '../common/SkeletonLoader';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-2 border-b border-[#D8E2EE] dark:border-slate-800 pb-2 overflow-x-auto no-scrollbar">
        <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
          ...
          <button
            onClick={() => handleSubTabChange('new-voucher')}
          ...
          <button
            onClick={() => handleSubTabChange('banking-cash')}
          ...
          <button
            onClick={() => handleSubTabChange('debtors-creditors')}
          ...
          <button
            onClick={() => handleSubTabChange('tax-brs')}
